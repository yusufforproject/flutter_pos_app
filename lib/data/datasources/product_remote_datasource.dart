...
class ProductRemoteDatasource {
  ...
  Future<Either<String, AddProductResponseModel>> addProduct(AddProductRequestModel addProductRequestModel) async {
    final authData = await AuthLocalDatasource().getAuthData();
    ...
    request.fields.addAll(addProductRequestModel.toMap());
    request.files.add(await http.MultipartFile.fromPath(
      'image', addProductRequestModel.image.path));
